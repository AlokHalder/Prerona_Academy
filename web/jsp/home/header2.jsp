...
<!--                            <div class="addthis_toolbox">-->
                                ...
                                <a href="https://www.facebook.com/PCS-Academy-962895277191221/" style="background-color: #5babfc;" target="_blank"><i style="color: #fff;" class="fa fa-facebook"></i></a> 
                    ...
                    <div class="head-login clearfix " style="padding-top: 7px;">
                        <ul class="ja-login">
                           ...
                           <li><%
                                if (session.getAttribute("ALLSTUDENTDATA") == null) {
                                %>
                                <a  style="border-radius: 10px;" class="register-switch" style="background: darkslategrey" href="javascript:void(0);">
                                    <span style="color: whitesmoke">Quick Register</span> 
                                </a> 
