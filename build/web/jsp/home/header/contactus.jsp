            ...
            <div class="col-lg-8 col-md-9 col-xs-12">
                <div class="row">
                    <div class="contact-address col-md-4 col-xs-12" style="padding-right: 5px;">
                        <div class="jicons-text" > Email: <span class="jicons-desc"></span> </div>
                    ...
                    <div class="contact-address col-md-4 col-xs-12">
                        <div class="jicons-text" > Mobile: <span class="jicons-desc"></span> </div>
                        <div class="contact-mobile"> <i class="fa fa-mobile">&nbsp;</i> +91 8697741611 </div>
                    </div>
